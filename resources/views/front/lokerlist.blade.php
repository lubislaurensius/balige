                ...
                <div class="col-md-5">
                    <div class="post-image">
                        <div class="flexslider" data-plugin-options='{"directionNav":true}'>
                            <ul class="slides">
                                <li>
                                    <img src="{{asset('upload/loker/'.$new->gambar)}}" />
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="post-meta">
                        ...
                        <a class="btn btn-xs btn-main-color pull-right" href="{{url('loker',$new->id_loker)}}">
                            Read more...
                        </a>
                    </div>
                </div>
