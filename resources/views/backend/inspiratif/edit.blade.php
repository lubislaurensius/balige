...
@stop
@section('content')
<div class="main-content" ng-controller="inspiratifedit">
    <div class="container">
        <!-- start: PAGE HEADER -->
        <div class="row">
            <div class="col-sm-12">
                <!-- start: PAGE TITLE & BREADCRUMB -->
{!! Breadcrumbs::render('indexinspiratifedit'); !!}
                ...
                <div class="tabbable">
                    ...
                    <div class="tab-content">
                        <div id="panel_tab2_example1" class="tab-pane active">
                            ...
                            <form class="form-horizontal" role="form" name="inspiratifForm" ng-submit="submit({{$data->id_inspiratif}})" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="form-field-1"> Nama Alumni </label>
                                    <div class="col-sm-9">
                                        <input type='text' class='col-sm-10 form-control' name='nama_alumni' ng-model="data.nama_alumni"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class='form-group'>
                                    <label class="col-sm-2 control-label" for="form-field-1"> Gambar </label>
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="{{asset('upload/inspiratif/'.$data->gambar)}}" alt=""/>
                                            </div>
