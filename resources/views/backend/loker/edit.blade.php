...
@stop
@section('content')
<div class="main-content" ng-controller="lokeredit">
    <div class="container">
        <!-- start: PAGE HEADER -->
        <div class="row">
            <div class="col-sm-12">
                <!-- start: PAGE TITLE & BREADCRUMB -->
{!! Breadcrumbs::render('indexlokeredit'); !!}
                ...
                <div class="tabbable">
                    ...
                    <div class="tab-content">
                        <div id="panel_tab2_example1" class="tab-pane active">
                            ...
                            <form class="form-horizontal" role="form" name="lokerForm" ng-submit="submit({{$data->id_loker}})" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="form-field-1"> Judul Loker </label>
                                    <div class="col-sm-9">
                                        <input type='text' class='col-sm-10 form-control' name='judul_loker' ng-model="data.judul_loker"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type='text' class='col-sm-10 form-control' name='keterangan' ng-model='data.keterangan' required/>
                                    </div>
                                </div>
                                <div class='form-group'>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <a href='{{route('admin.loker.index')}}' class="btn btn-blue">Back</a>
                                    </div>
                                </div>
                            </form>
                        </div>
