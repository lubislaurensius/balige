                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a class="btn btn-green add-row" href="{{route('admin.kelas.create')}}">
                            Tambah Tahun Lulusan <i class="fa fa-plus"></i>
                        </a>
                        <a class="btn btn-green add-row" href="{{route('admin.kelas.{id}.siswa.create', 1)}}">
                            Tambah Alumni <i class="fa fa-user"></i>
                        </a>
                                ...
                                <tr ng-repeat="status in data| filter:paginate">
                                    ...
                                    <td class="center">
                                        <div class="visible-md visible-lg hidden-sm hidden-xs">
                                            <a data-original-title="Siswa" data-placement="top" class="btn btn-xs btn-success tooltips" href="{{url('admin/kelas')}}/<% status['id_kelas']%>/siswa"><i class="fa fa-user"></i> Lihat Alumni</a>
                                                ...
                                                <ul class="dropdown-menu pull-right" role="menu">
                                                    <li role="presentation">
                                                        <a href="{{url('admin/siswa')}}/<% status['id_data']%>/edit" tabindex="-1" role="menuitem">
                                                            <i class="fa fa-user"></i> Lihat Alumni
                                                        </a>
                                                    </li>
                                                    <li role="presentation">
